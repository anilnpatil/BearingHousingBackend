...
public class BearingHousingConstants {
    ...
    // public static final String COLUMN_TOX_START_LOAD = "tox_start_load";
    // public static final String COLUMN_TOX_MID_LOAD = "tox_mid_load";
    // public static final String COLUMN_TOX_END_LOAD = "tox_end_load";
    // public static final String COLUMN_TOX_START_DISPLACEMENT = "tox_start_displacement";
    // public static final String COLUMN_TOX_MID_DISPLACEMENT = "tox_mid_displacement";
    // public static final String COLUMN_TOX_END_DISPLACEMENT = "tox_end_displacement";
    ...
    public static final String COLUMN_P1_TOX_START_LOAD = "p1_tox_start_load";
    public static final String COLUMN_P1_TOX_MID_LOAD = "p1_tox_mid_load";
    public static final String COLUMN_P1_TOX_END_LOAD = "p1_tox_end_load";
    public static final String COLUMN_P1_TOX_START_DISPLACEMENT = "p1_tox_start_displacement";
    public static final String COLUMN_P1_TOX_MID_DISPLACEMENT = "p1_tox_mid_displacement";
    public static final String COLUMN_P1_TOX_END_DISPLACEMENT = "p1_tox_end_displacement";
    ...
    public static final String COLUMN_P2_TOX_START_LOAD = "p2_tox_start_load";
    public static final String COLUMN_P2_TOX_MID_LOAD = "p2_tox_mid_load";
    public static final String COLUMN_P2_TOX_END_LOAD = "p2_tox_end_load";
    public static final String COLUMN_P2_TOX_START_DISPLACEMENT = "p2_tox_start_displacement";
